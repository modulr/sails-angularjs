...
module.exports = function notFound (data, options) {
  ...
  if (data !== undefined) {
    sails.log.verbose('Sending 302 ("Not Found") response: \n',data);
  }
  else sails.log.verbose('Sending 302 ("Not Found") response');
  ...
  else return res.view('302', { data: data }, function (err, html) {
